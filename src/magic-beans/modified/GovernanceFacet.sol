...
import "../original/interfaces/IBean.sol";
import "../original/libraries/LibInternal.sol";
import "../original/libraries/LibIncentive.sol";

/**
 * @author Publius
 * @title Governance handles propsing, voting for and committing BIPs as well as pausing/unpausing.
**/
contract GovernanceFacetModified is VotingBooth {
